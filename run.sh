...
python imagenet_eval.py --data_dir /HARD-DATA/data/DATASET/ILSVRC2012_img_val/ \
  --uaps_save "$uaps_save_path" \
...
uaps_save_path="result/"

CUDA_VISIBLE_DEVICES=1 python imagenet_attack.py --data_dir /HARD-DATA/XYZ/Stochastic-Gradient-Aggregation-main/data/model_fit/dataset/imagenet_sub_500/ \
    --uaps_save "$uaps_save_path" \
    --batch_size 125 --alpha 10 --epoch 20 --dm 1 \
    --num_images 500 \
    --model_name vgg19 --Momentum 0 --cross_loss 1\
...
uaps_save_path="result/dm_500_20epoch_125batch.pth"
uaps_save_path2="result/result.log"
